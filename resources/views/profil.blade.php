...
<div class="" id="mode">
    ...
    <header class="absolute inset-x-0 top-0 z-50">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <button onclick="mode()"><a href="#" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">Log in <span aria-hidden="true">&rarr;</span></a></button>
        </div>
        </nav>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="text-center">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl dark:text-white">Data to enrich your {{$hasil}} online business</h1>
            <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-white">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
    ...
    <div class="md:columns-3 sm:columns-1 space-y-4 my-3 mx-2">
    @for ($i = 0; $i < $hasil*3; $i++)
